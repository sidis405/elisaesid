...
?>
    ...
    <div style="padding:10px;float:left;" id="slideshow_large_image">
     ...
     <div style="float:left;">
        ...
        <img src="<?php echo $slideshow_large_image_url; ?>" width="300" height="120" alt="<?php the_title(); ?>" />
        <?php }?>
		</div>
...
{
    add_meta_box('custom_meta', __('Post Custom Options','admincore'), 'com_post_meta', 'post', 'normal', 'high');
}
